...
export const QNAIGC_MODELS = [
  ...
  { id: "moonshotai/kimi-k2.5", name: "Moonshot AI Kimi K2.5 (QNAIGC)", reasoning: false, input: ["text"], cost: { input: 0, output: 0, cacheRead: 0, cacheWrite: 0 }, contextWindow: 256000, maxTokens: 256000 },
  { id: "xiaomi/mimo-v2-flash", name: "Xiaomi Mimo-V2-Flash (QNAIGC)", reasoning: false, input: ["text"], cost: { input: 0, output: 0, cacheRead: 0, cacheWrite: 0 }, contextWindow: 256000, maxTokens: 256000 },
